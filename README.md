# 诺玛建工
除非另有声明，本仓库内容采用[CC BY-NC-SA 3.0](https://creativecommons.org/licenses/by-nc-sa/3.0/)授权。  
[诺玛建工](https://github.com/NorthernOceanS/NormaConstructor)，一个为Minecraft基岩版设计的，基于Minecraft 脚本引擎的快速建造附加包，加快您的建筑过程。  
